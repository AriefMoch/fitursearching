...
<div id="header-wrap" class="clr">
    	<div id="header" class="container row clr">   
            <div id="logo" class="col span_4">
                ...
                <?php if ($logo != null ) : ?>
            <a href="<?php echo $this->baseurl ?>"><img src="<?php echo $this->baseurl ?>/<?php echo htmlspecialchars($logo); ?>" alt="<?php echo htmlspecialchars($sitetitle);?>" /></a>
                <?php else : ?>
            ...
            <a href="<?php echo $this->baseurl ?>"><span class="first"><?php echo htmlspecialchars($title[0]);?></span><span class="second"><?php for ($t=1; $t<count($title); $t++){echo htmlspecialchars(" ".$title[$t]);}?></span></a>
                <?php endif; ?>
                <?php if ($sitedesc !== '' ) : ?>
...
<div class="smartone"><?php jlink(); ?></div>
<?php } ?> 
<div id="wrapper-w">
