...
<fieldset class="adminform"><legend>Daftar Produk Hukum</legend> 
...
<td>:</td>
<td align="left" width="100%"><select id="search-searchword" class="inputbox" name="searchword">
...
<td>:</td>
<td><select id="search-searchword" class="inputbox" name="searchword">
...
<td>:</td>
<td><select id="search" class="inputbox" name="search">
...
<td>:</td>
<form id="searchForm" action="/joom372/index.php/cari-peraturan/search" method="post" accept-charset="utf-8">
	<fieldset class="word">
...
<tr>
<td colspan="3"><button name="Search"  onclick="this.form.submit()" class="button"><?php echo JText::_('COM_JDOWNLOADS_SEARCH');?></button>
