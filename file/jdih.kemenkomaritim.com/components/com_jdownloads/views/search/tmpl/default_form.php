...
<form id="searchForm" action="<?php echo JRoute::_('index.php?option=com_jdownloads&view=search');?>" method="post" accept-charset="utf-8">
    <fieldset class="word">
		...
		<p>
                ...
                <table class="contentpaneopen" style="margin-left: auto; margin-right: auto;" width="570">
<tbody>
<tr>
<td class="contentheading" align="center" width="570"><strong><span style="font-size: large;">JARINGAN DOKUMENTASI DAN INFORMASI HUKUM</span></strong></td>
</tr>
</tbody>
</table>
        ...
        <table style="height: 112px;" border="0" width="461" cellspacing="2" cellpadding="3">
            
            <thead>
                <th colspan="3">Pencarian Data Produk Hukum :
					</th>
            </thead>

<tbody>
<tr>
<td width="20%">Jenis Produk Hukum</td>
<td>:</td>
<td align="left" width="100%"><select id="cat_dir" class="inputbox" name="cat_dir">
<option selected="selected" value="0">- Pilih Jenis Peraturan -</option>
<option value="Undang-Undang">Undang-Undang</option>
<option value="PP pengganti UU">PP pengganti UU</option>
...
<option value="RUU Ratifikasi">RUU Ratifikasi</option>
...
<tr>
<td>Diterbitkan Tahun</td>
<td>:</td>
<td><select id="search-searchword2" class="inputbox" name="search-searchword2">
...
<td>:</td>
		<label for="search-searchword"></label>
<td align="left" width="50%"><input id="search-searchword" class="text_area" name="searchword" size="100" type="text" value="" /></td>
</tr>
<tr>
<td colspan="3"><button name="Search"  onclick="document.getElementById('cat_dir').value = ''; document.getElementById('search-searchword1').value = 'search-searchword1'; document.getElementById('search-searchword2').value = ''; document.getElementById('search-searchword3').value = '';this.form.submit();" class="button"><?php echo JText::_('COM_JDOWNLOADS_SEARCH');?></button>
                
        <button name="Resetit" onclick="this.form.reset.value = 1;this.form.submit();" class="button"><?php echo JText::_('COM_JDOWNLOADS_SEARCH_RESET');?></button></td>
</tr>              
...
<form>
	...
	<div class="searchintro<?php echo $this->params->get('pageclass_sfx'); ?>">
        ...
        <div><?php echo JText::plural('COM_JDOWNLOADS_SEARCH_KEYWORD_N_RESULTS', $this->total);?></div>
		<?php endif;?>
	</div>
